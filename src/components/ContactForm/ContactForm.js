...
import HeaderImage from '../homeImage';
...
class ContactForm extends Component {
  ...
  changeForm = () =>
    this.setState({
      value: this.state.value === 'contact' ? 'application' : 'contact',
    });
  render() {
    const {
      email,
                ...
                <Grid.Column computer={'12'} tablet={'12'}>
                  <Item.Group>
                    <Item>
                      <Item.Content>
                        <Item.Description>
                          Let us know what we can help you with. Contact us and
                      ...
                      <label>
                        ...
                        {false ? (
                          <a
                            ...
                            href={'#'}
                            style={{
                              textDecoration: false ? 'underline' : 'inherit',
                            }}
                          >
                            {this.state.value === 'contact'
                              ? 'apply today!'
                ...
                <Grid.Column computer={'12'} mobile={'14'}>
                  <Divider horizontal>
                    <Header
                      ...
                      textAlign={'center'}
                    >
                      Would you like to apply? Download our application and
                      email it to us!
                    </Header>
                  </Divider>
                  <PDF />
